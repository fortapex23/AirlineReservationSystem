...
{
	public record FlightGetDto(int Id, int FlightNumber, int DepartureAirportId, int ArrivalAirportId, int AirlineId,
							int PlaneId, DateTime DepartureTime, DateTime ArrivalTime, 
